...
if __name__ == '__main__':
      ...
      0.94809132, 0.94809132, 0.91225896, 0.81251641])
       ...
       0.88327863, 0.88327863, 0.87877124, 0.80977114])
        ...
        #2.0 and fixed omega
       #  super4 = np.array([0.7197495 , 0.82803137, 0.94968004, 0.93055822, 0.82745061,
       # 0.92986772, 0.94850776, 0.82714091, 0.71974028])
       #  super7 = np.array([0.75837509, 0.83218592, 0.83654642, 0.82551968, 0.74599994,
       # 0.82547631, 0.83638061, 0.83171171, 0.75796929])
       #  super10 = np.array([0.82225483, 0.81452143, 0.81205684, 0.80658794, 0.73339604,
       # 0.80658229, 0.81203934, 0.814506  , 0.82185839])
       ...
       # 0.80658229, 0.81203934, 0.814506  , 0.82185839])
        ...
        # 3
       #  super4 = np.array([0.94429728, 0.98502759, 0.97330775, 1.00447455, 1.02526276,
       # 1.00283477, 0.96304977, 0.99087701, 0.92655715])
       #  super7 = np.array([0.98523959, 0.97224506, 0.98130249, 0.98496348, 0.96037924,
       # 0.9886835 , 0.96903042, 0.96125932, 0.97049037])
       #  super10 = np.array([0.91933005, 0.93595487, 0.94413618, 0.92833491, 0.89210531,
       # 0.93120719, 0.92008385, 0.91197694, 0.92779689])

        # 1.5
       #  super4 = np.array([0.65551085, 0.71012291, 0.80801012, 0.95716792, 1.02526276,
       # 0.95761215, 0.78766605, 0.70717952, 0.65791763])
       #  super7 = np.array([0.73809307, 0.83203909, 0.92741966, 0.98496348, 0.96037924,
       # 0.9886835 , 0.92234664, 0.8139222 , 0.72271102])
       #  super10 = np.array([0.7921991 , 0.88356947, 0.94413618, 0.92833491, 0.89210531,
       # 0.93120719, 0.92008385, 0.86521767, 0.78842302])

        # 1.
       #  super4 = np.array([0.63353188, 0.63499813, 0.70210052, 0.82609611, 0.90413748,
       # 0.83231446, 0.67529408, 0.62965189, 0.637472  ])
       #  super7 = np.array([0.66408625, 0.72982293, 0.7906944 , 0.91111381, 0.96037924,
       # 0.91376397, 0.80388867, 0.70650713, 0.6485147 ])
       #  super10 = np.array([0.69413751, 0.75912991, 0.84336117, 0.91783536, 0.89210531,
       # 0.92020988, 0.83027765, 0.75414277, 0.68091793])

        # 2
       #  super4 = np.array([0.73198445, 0.81004548, 0.91670953, 1.00447455, 1.02526276,
       # 1.00283477, 0.90299806, 0.81029811, 0.72905612])
       #  super7 = np.array([0.85077162, 0.93935213, 0.98130249, 0.98496348, 0.96037924,
       # 0.9886835 , 0.96903042, 0.92669339, 0.83567809])
       #  super10 = np.array([0.89958267, 0.93595487, 0.94413618, 0.92833491, 0.89210531,
       # 0.93120719, 0.92008385, 0.91197694, 0.90614781])

        # 1.75
       #  super4 = np.array([0.68918819, 0.75813723, 0.86405125, 1.00087988, 1.02526276,
       # 0.99939846, 0.84712669, 0.75672957, 0.6892455 ])
       #  super7 = np.array([0.79196597, 0.88819248, 0.97677591, 0.98496348, 0.96037924,
       # 0.9886835 , 0.96510862, 0.87293166, 0.77672186])
       #  super10 = np.array([0.8492401 , 0.93128046, 0.94413618, 0.92833491, 0.89210531,
       # 0.93120719, 0.92008385, 0.90780456, 0.85095716])
