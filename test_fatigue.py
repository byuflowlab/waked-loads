...
if __name__ == '__main__':
        ...
        ax1.plot(offset,FAST4,'or',label='FAST')
        ax1.plot(offset,super4,'ob',label='superimposed')
        ...
        ax2.plot(offset,FAST7,'or')
        ax2.plot(offset,super7,'ob')
        ax2.plot(offset,FASTfree,'ok')
        ax2.plot(offset,freestreamCC,'og')
        ax2.set_title('7D')
        ax2.set_xlabel('offset (D)')

        ax3.plot(offset,FAST10,'or')
        ax3.plot(offset,super10,'ob')
